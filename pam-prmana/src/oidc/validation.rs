...
pub struct ValidationConfig {
    ...
    ///
    /// Replaces the old `PRMANA_DISABLE_JTI_CHECK` environment variable.
...
impl ValidationConfig {
    pub fn from_env() -> Result<Self, ValidationError> {
        ...
        let client_id = std::env::var("OIDC_CLIENT_ID").unwrap_or_else(|_| "prmana".into());
...
mod tests {
    ...
    fn test_validation_config_from_env() {
        ...
        assert_eq!(config.client_id, "prmana");
    ...
    fn create_expired_test_token() -> String {
        ...
        let payload = r#"{"sub":"testuser","preferred_username":"testuser","iss":"http://localhost:8080/realms/test","aud":"prmana","exp":1577836800,"iat":1577836700}"#;
    ...
    fn create_valid_test_token() -> String {
        ...
        let payload = r#"{"sub":"testuser","preferred_username":"testuser","iss":"http://localhost:8080/realms/test","aud":"prmana","exp":1893456000,"iat":1705400000,"acr":"urn:example:acr:mfa","auth_time":1705400000,"jti":"test-token-id"}"#;
    ...
    fn create_token_without_jti() -> String {
        ...
        let payload = r#"{"sub":"testuser","preferred_username":"testuser","iss":"http://localhost:8080/realms/test","aud":"prmana","exp":1893456000,"iat":1705400000,"acr":"urn:example:acr:mfa","auth_time":1705400000}"#;
    ...
    fn create_token_without_auth_time() -> String {
        ...
        let payload = r#"{"sub":"testuser","preferred_username":"testuser","iss":"http://localhost:8080/realms/test","aud":"prmana","exp":1893456000,"iat":1705400000,"acr":"urn:example:acr:mfa","jti":"test-token-id"}"#;
    ...
    fn create_token_with_old_auth_time() -> String {
        ...
        let payload = r#"{"sub":"testuser","preferred_username":"testuser","iss":"http://localhost:8080/realms/test","aud":"prmana","exp":1893456000,"iat":1705400000,"acr":"urn:example:acr:mfa","auth_time":1577836800,"jti":"test-token-id"}"#;
