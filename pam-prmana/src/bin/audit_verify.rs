//! prmana-audit-verify — HMAC chain verification for audit log files.
//!
...
//! the key was originally set in `PRMANA_AUDIT_HMAC_KEY`.
//!
//! # Security
//!
...
/// Verify the HMAC tamper-evidence chain of a prmana audit log.
#[derive(Parser, Debug)]
#[command(name = "prmana-audit-verify")]
#[command(about = "Verify the HMAC chain of a prmana audit log file")]
#[command(long_about = None)]
struct Cli {
    /// HMAC key as a UTF-8 string (same value as PRMANA_AUDIT_HMAC_KEY)
