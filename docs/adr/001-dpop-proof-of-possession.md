...
1. **Client-generated key pairs**: Each `prmana-agent` generates an ephemeral P-256 ECDSA key pair
...
- [Agent DPoP signing](../../prmana-agent/src/crypto/dpop.rs)
- [PAM DPoP validation](../../pam-prmana/src/oidc/dpop.rs)
